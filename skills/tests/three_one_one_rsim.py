    ...
    for iter in range(2000):
        ...
        if stage == 0:
            ...
            for i in range(N_ROBOTS_ATTACK):
                ...
                all_in_pos = (
                    all_in_pos
                    and math.dist(target_pos[i], (robot_data.x, robot_data.y)) < 0.01
                )
            ...
            print(
                ...
                "Next possessor",
                next_possessor,
                sim_robot_controller_attacker.robot_has_ball(next_possessor),
            )
            if sim_robot_controller_attacker.robot_has_ball(next_possessor):
                ...
                print(
                    "Possessor dribblle",
                    possessor_cmd.dribble,
                    "Receiver dribble",
                    next_possessor_cmd.dribble,
                )
                sim_robot_controller_attacker.send_robot_commands()
        elif stage == 3:
            print("SCOOOORING")
