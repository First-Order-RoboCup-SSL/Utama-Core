...
# Vision ID → firmware command ID mapping.
# Update before running on real hardware: vision ID is the sticker on the robot,
# command ID is baked into the robot's firmware.
YELLOW_VISION_TO_CMD = {
    0: 0,  # vision ID 0 → cmd ID 0  ← update with actual firmware ID
}
