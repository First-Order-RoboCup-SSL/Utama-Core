...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        ssl__vision__geometry__pb2.DESCRIPTOR,
...
_ROBOTLIMITS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="acc_speedup_absolute_max",
            full_name="RobotLimits.acc_speedup_absolute_max",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="acc_speedup_angular_max",
            full_name="RobotLimits.acc_speedup_angular_max",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="acc_brake_absolute_max",
            full_name="RobotLimits.acc_brake_absolute_max",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="acc_brake_angular_max",
            full_name="RobotLimits.acc_brake_angular_max",
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="vel_absolute_max",
            full_name="RobotLimits.vel_absolute_max",
            index=4,
            number=5,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="vel_angular_max",
            full_name="RobotLimits.vel_angular_max",
            index=5,
            number=6,
            type=2,
            cpp_type=6,
...
_ROBOTWHEELANGLES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="front_right",
            full_name="RobotWheelAngles.front_right",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="back_right",
            full_name="RobotWheelAngles.back_right",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="back_left",
            full_name="RobotWheelAngles.back_left",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="front_left",
            full_name="RobotWheelAngles.front_left",
            index=3,
            number=4,
            type=2,
            cpp_type=6,
...
_ROBOTSPECS = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="max_linear_kick_speed",
            full_name="RobotSpecs.max_linear_kick_speed",
            index=4,
            number=7,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="max_chip_kick_speed",
            full_name="RobotSpecs.max_chip_kick_speed",
            index=5,
            number=8,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="center_to_dribbler",
            full_name="RobotSpecs.center_to_dribbler",
            index=6,
            number=9,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="wheel_angles",
            full_name="RobotSpecs.wheel_angles",
            index=8,
            number=13,
            type=11,
            cpp_type=10,
...
_REALISMCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="custom",
            full_name="RealismConfig.custom",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_SIMULATORCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="geometry",
            full_name="SimulatorConfig.geometry",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="robot_specs",
            full_name="SimulatorConfig.robot_specs",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="realism_config",
            full_name="SimulatorConfig.realism_config",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="vision_port",
            full_name="SimulatorConfig.vision_port",
            index=3,
            number=4,
            type=13,
            cpp_type=3,
...
RobotLimits = _reflection.GeneratedProtocolMessageType(
    "RobotLimits",
    (_message.Message,),
    {
...
RobotWheelAngles = _reflection.GeneratedProtocolMessageType(
    "RobotWheelAngles",
    (_message.Message,),
    {
...
RobotSpecs = _reflection.GeneratedProtocolMessageType(
    "RobotSpecs",
    (_message.Message,),
    {
...
RealismConfig = _reflection.GeneratedProtocolMessageType(
    "RealismConfig",
    (_message.Message,),
    {
...
SimulatorConfig = _reflection.GeneratedProtocolMessageType(
    "SimulatorConfig",
    (_message.Message,),
    {
