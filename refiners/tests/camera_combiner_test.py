...
def test_combine_proximity_multiple_balls():
    ...
    balls = {0: [RawBallData(0,0,0, 1), RawBallData(5,5,0, 1)], 1:[RawBallData(0.02, 0.03,0, 1), RawBallData(1,1,0,1)]}
    balls = c._combine_balls_by_proximity(balls)
    assert len(balls) == 4

def test_combine_filters_low_confidence():
    balls = {0: [RawBallData(0,0,0, 0.05), RawBallData(5,5,0, 0.05)], 1:[RawBallData(0.02, 0.03,0, 0.05)]}
