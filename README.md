...
5. `pixi run replay -n <file_name> [-p: stepthrough play-by-play]` runs the replay file stored in `./replays` folder. If no `--replay-file` flag provided, defaults to latest replay in the folder.
