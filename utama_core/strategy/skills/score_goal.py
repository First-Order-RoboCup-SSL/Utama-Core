...
from utama_core.skills.src.score_goal import score_goal
...
from utama_core.strategy.utils.action_nodes import KickStep, TurnOnSpotStep
from utama_core.strategy.utils.atk_utils import (
    GoalBlocked,
    OrenAtTargetThreshold,
    ShouldScoreGoal,
)
from utama_core.strategy.utils.blackboard_utils import SetBlackboardVariable
from utama_core.strategy.utils.selector_utils import GoalScored
