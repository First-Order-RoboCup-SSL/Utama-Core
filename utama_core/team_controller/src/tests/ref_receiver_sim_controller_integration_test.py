...
from utama_core.team_controller.src.controllers import GRSimController
from utama_core.team_controller.src.data import RefereeMessageReceiver
                ...
                if len(yellow_team_yellow_card_times) != 0 and len(yellow_team_yellow_card_times) > len(
                    ...
                    for _ in range(robots_to_add):
                        sim_control.set_robot_presence(
                            ...
                            team_colour_is_blue=False,
                            should_robot_be_present=True,
                        )
