...
from utama_core.global_utils.math_utils import squared_distance
...
def test_2v5(friendly_robot_ids: List[int], attacker_is_yellow: bool, headless: bool):
    ...
    for iter in range(2000):
        ...
        if iter > 10:  # give them chance to spawn in the correct place
            ...
            player3_has_ball = sim_robot_controller_attacker.robot_has_ball(player3_id)
            player4_has_ball = sim_robot_controller_attacker.robot_has_ball(player4_id)
            ...
            if player1_has_ball:
                ...
                ball_possessor_id = player3_id
            elif player4_has_ball:
                ball_possessor_id = player4_id
