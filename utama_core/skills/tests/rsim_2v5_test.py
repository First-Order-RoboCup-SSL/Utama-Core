...
def test_2v5(friendly_robot_ids: List[int], attacker_is_yellow: bool, headless: bool):
    ...
    for iter in range(2000):
        ...
        """sim_robot_controller_defender.add_robot_commands( defend(

        pid_oren_defender, pid_2d_defender, game, not attacker_is_yellow, 4, env     ),     4, )
        """
        ...
        """sim_robot_controller_defender.add_robot_commands( man_mark( not attacker_is_yellow, game, 2, 0,
        pid_oren_defender,

        pid_2d_defender,     ),     2, )

        sim_robot_controller_defender.add_robot_commands(     man_mark(         not attacker_is_yellow,         game, 3,
        0,         pid_oren_defender,         pid_2d_defender,     ),     3, )
        """
