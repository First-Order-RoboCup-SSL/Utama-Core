...
class Attack(Role):    
    def __post_init__(self):
        ...
        self.possible_actions = [
                Action(0, name="pass"), Action(1, name="shoot_to_goal"), Action(2, name="go_to_ball"), 
                Action(3, name="cross_ball"), Action(4, name="receive_then_score")
            ],
...
class Defend(Role):
    def __post_init__(self):
        ...
        self.possible_actions = [
            Action(0, name="pass"), Action(1, name="man_mark"), Action(2, name="intercept_ball"), 
            Action(3, name="tackle ball"), Action(4, name="clear ball"), Action(5, name="block"), 
            Action(6, name="go_to_ball"), Action(7, name="receive_ball")
            ]  
