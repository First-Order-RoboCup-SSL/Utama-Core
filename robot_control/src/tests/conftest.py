...
# test value sets.
parameter_values = {
    ("shooter_id",): {"quick": [5], "full": range(3, 6)},
    (
        "is_yellow",
        "defender_is_yellow",
    ): {  # Probably worth running both colours even in quick mode
        "quick": [False, True],
        "full": [False, True],
    },
    ("robot_to_place",): {"quick": [1], "full": range(6)},
    ("target_robot",): {"quick": [1], "full": [1]},
    ("defender_id",): {"quick": [1], "full": [1, 2]},
}
